<template>
  <div class="text-input__wrapper">
    ...
    <textarea :name="$attrs.name" :id="$attrs.id" :ref="$attrs.ref" :placeholder="$attrs.placeholder" class="text-input" :class="{ 'has-error': error !== '' }" v-model="m_value" @input="$emit('input', m_value)" />
